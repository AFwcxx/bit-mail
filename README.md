...
v0.1.7 is release-ready; publication and hosted verification are tracked under
...
```bash
cargo install --locked --force --git https://github.com/AFwcxx/bit-mail --tag v0.1.7 bit-mail
mkdir ~/mail-triage
cd ~/mail-triage
bit-mail init
bit-mail connect
