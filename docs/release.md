...
bit-mail v0.1.5 supports Rust 1.88 or newer on Linux and macOS. Rust 1.88 is
...
| Embedded runtime assets | binary version (`0.1.5`) |
...
gh attestation verify bit-mail-v0.1.5-<target>.tar.gz --repo AFwcxx/bit-mail
```
