...
The requirements baseline through canonical mail storage are complete. The pull engine is next; progress is tracked under [`docs/milestones/`](docs/milestones/README.md).
